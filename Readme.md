...
* Из-за ошибки генерации правильных заголовков в iOS9 происходит возврат ошибки при использовании тестовых карт с тестовым сервером 3DS-авторизации (https://demo.cloudpayments.ru/acs). Для предотвращения такой ошибки небходимо вручную выставлять корректное значение для HTTP-заголовка Accept-Language:
